...
Master inventory of all repositories in the [codev-workshops](https://github.com/orgs/codev-workshops/repositories) GitHub org.
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-legacy-modernization-cobol-to-java |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-legacy-modernization-oracle-forms-to-java |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-spring-boot-upgrade-microservice-extraction |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-cve-remediation-regulatory-compliance |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-data-source-migration-jdbc-normalization |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-dw-migration-teradata-to-snowflake |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-dw-migration-teradata-to-bigquery |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-data-migration-abinitio-to-pyspark |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-data-migration-abinitio-to-databricks |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-data-migration-sas-to-snowflake |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-data-migration-sas-to-databricks |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-data-migration-airflow |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-java-upgrade-broadleaf-commerce |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-product-analysis-loan-modernization |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-pod-remediation-credential-rotation |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-document-review-automation |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-api-migration-mulesoft-to-spring-boot |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-bdd-test-generation-cucumber |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/uc-volume-anomaly-detection |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/i-retail-mern-ecommerce |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ts-informatica-powercenter |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ts-plsql-oracle-forms-hrms |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ts-angular-realworld |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ts-java-angular-jhipster |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ts-java-mulesoft-employee-api |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ts-python-abinitio-etl |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ts-sas-legacy-analytics |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ts-java-selenium-testng |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ts-java-swagger-petstore |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ts-java-spring-boot-internet-banking |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ts-java-spring-boot-realworld |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/petclinic-rest-api |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/petclinic-angular |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/petclinic-backend |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/petclinic-microservices |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ordermanager-monolith |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ordermanager-iac |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ordermanager-microservices |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/eventflow-storefront |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/quickapp-monolith |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/quickapp-microservices |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/quickapp-microfrontends |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/quickapp-iac |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/timesheet-app |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/timesheet-infra |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/calcom |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/calcom-infra |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/calcom-dataeng |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ts-react-coreui-admin |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ts-cobol-carddemo |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/ts-dart-flutter-ecommerce |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/jpetstore-6 |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/fineract |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/modular-monolith-ddd |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/platform-engineering-shared-services |
...
| | |
|---|---|
| **URL** | https://github.com/codev-workshops/otterworks |
...
|------|-------------|-----------|
| [ts-python-aws-personalize](https://github.com/codev-workshops/ts-python-aws-personalize) | AWS Personalize ML workshop | Python, AWS |
| [ts-angularjs-blur-admin](https://github.com/codev-workshops/ts-angularjs-blur-admin) | AngularJS 1.x admin panel | AngularJS, Bootstrap |
| [ts-angularjs-dashboard-widgets](https://github.com/codev-workshops/ts-angularjs-dashboard-widgets) | AngularJS dashboard widgets | AngularJS |
| [ts-informatica-powercenter](https://github.com/codev-workshops/ts-informatica-powercenter) | Informatica PowerCenter 9.6.1 XML exports (11 mappings, 117K lines), Oracle SQL, shell orchestration — see [full entry](#ts-informatica-powercenter) | Informatica PowerCenter, Oracle, Shell |
| [ts-katalon-web-automation](https://github.com/codev-workshops/ts-katalon-web-automation) | Katalon web automation sample | Katalon |
| [keycloak](https://github.com/codev-workshops/keycloak) | Identity and Access Management | Java |
| [fineract-web-app](https://github.com/codev-workshops/fineract-web-app) | Mifos X Web App (Fineract frontend) | Angular |
| [ofbiz-framework](https://github.com/codev-workshops/ofbiz-framework) | Apache OFBiz ERP/CRM | Java |
| [openmrs-core](https://github.com/codev-workshops/openmrs-core) | OpenMRS medical records | Java |
| [ts-java-real-estate-management](https://github.com/codev-workshops/ts-java-real-estate-management) | Real estate property management | Java |
| [ruby-redmine](https://github.com/codev-workshops/ruby-redmine) | Redmine project management | Ruby |
| [ts-serverless-digital-asset-payments](https://github.com/codev-workshops/ts-serverless-digital-asset-payments) | Serverless digital asset payments | AWS, Serverless |
| [ts-serverless-eda-insurance-claims](https://github.com/codev-workshops/ts-serverless-eda-insurance-claims) | Event-driven insurance claims | AWS, Serverless |
| [ts-python-streamify-data-engineering](https://github.com/codev-workshops/ts-python-streamify-data-engineering) | Data engineering with Kafka, Spark, dbt | Python, Kafka, Spark, dbt |
| [traderx](https://github.com/codev-workshops/traderx) | TraderX fork for Devin demos | Java |
